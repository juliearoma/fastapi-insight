...
class PostBase(BaseModel):
    ...
    text: Annotated[str, Field(min_length=1, max_length=16383, examples=["This is the content of my post."])]
...
class PostUpdate(BaseModel):
    ...
    text: Annotated[
        str | None,
        Field(min_length=1, max_length=16383, examples=["This is the updated content of my post."], default=None),
    ]
    media_url: Annotated[
        str | None,
        Field(pattern=r"^(https?|ftp)://[^\s/$.?#].[^\s]*$", examples=["https://www.postimageurl.com"], default=None),
